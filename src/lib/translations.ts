export const translations = {
  en: {
    ...
    address: "Address",
    addressDetails: "Country: BULGARIA, Region: Sofia (capital), Municipality: Sofia (Metropolitan), city of Sofia, postal code 1407, Lozenets district, Lozenets neighborhood, Lyubata St./Blvd., block 14, entrance G, 6th floor, apartment 66",
  ...
  bg: {
    ...
    address: "Адрес",
    addressDetails: "Държава: БЪЛГАРИЯ, Област: София (столица), Община: Столична, гр. София, п.к. 1407, р-н Лозенец, ж.к. Лозенец, бул./ул. Любата, бл. 14, вх. Г, ет. 6, ап. 66",
